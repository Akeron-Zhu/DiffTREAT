  ...
  if (destination.IsBroadcast() || destination.IsLocalMulticast())
  {
         ...
         ifaceIter != m_interfaces.end(); ifaceIter++, ifaceIndex++)
    {
      ...
      if (sendIt)
      {
        ...
        TcpHeader tcpHeader;
        uint32_t bytesRemoved = packetCopy2->RemoveHeader(tcpHeader);
        /***************************************************************************/
        m_sendOutgoingTrace(ipHeader, packetCopy, ifaceIndex);
        /***************************************************************************
        packetCopy2->AddHeader(tcpHeader);
        /***************************************************************************/
...
void Ipv4L3Protocol::SendCache(Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
