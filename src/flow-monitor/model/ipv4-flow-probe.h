...
//在一个节点IPv4层处监视流，仿真中的每个节点都有一个这个实例，用于监视节点，其通过IPv4L3Protocol中的trace source获取信息
...
/************************************************************/
  void QueueDiscDropLogger (Ptr<const Packet> ipPayload);
  void AppPacketReceiveLogger (Ptr< const Packet > packet, const Address &address, const Address &local);
  
  //这个Probe相关联的classifier与相关的Ipv4L3Protocol
