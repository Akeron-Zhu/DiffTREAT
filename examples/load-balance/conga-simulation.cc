...
int main(int argc, char *argv[])
{
    ...
    if (runMode == CONGA || runMode == CONGA_FLOW || runMode == CONGA_ECMP)
    {
        ...
        {
            staticRoutingHelper.GetStaticRouting(servers0.Get(serverIndex)->GetObject<Ipv4>())->AddNetworkRouteTo(Ipv4Address("0.0.0.0"), Ipv4Mask("0.0.0.0"), 1);

            congaRoutingHelper.GetCongaRouting(leaf0->GetObject<Ipv4>())->AddRoute(serversAddr0[serverIndex].first, Ipv4Mask("255.255.255.255"), serversAddr0[serverIndex].second);

            staticRoutingHelper.GetStaticRouting(servers1.Get(serverIndex)->GetObject<Ipv4>())->AddNetworkRouteTo(Ipv4Address("0.0.0.0"), Ipv4Mask("0.0.0.0"), 1);

            congaRoutingHelper.GetCongaRouting(leaf1->GetObject<Ipv4>())->AddRoute(serversAddr1[serverIndex].first, Ipv4Mask("255.255.255.255"), serversAddr1[serverIndex].second);
        }

        congaRoutingHelper.GetCongaRouting(leaf0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine0_1.Get(0)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(leaf0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine0_2.Get(0)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(leaf0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine1_1.Get(0)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(leaf0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine1_2.Get(0)->GetIfIndex());

        congaRoutingHelper.GetCongaRouting(leaf1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine0_1.Get(0)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(leaf1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine0_2.Get(0)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(leaf1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine1_1.Get(0)->GetIfIndex());
        if (!asym)
        {
            congaRoutingHelper.GetCongaRouting(leaf1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine1_2.Get(0)->GetIfIndex());
        }

        congaRoutingHelper.GetCongaRouting(spine0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine0_1.Get(1)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(spine0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine0_2.Get(1)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(spine0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine0_1.Get(1)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(spine0->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine0_2.Get(1)->GetIfIndex());

        congaRoutingHelper.GetCongaRouting(spine1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine1_1.Get(1)->GetIfIndex());
        if (!asym)
        {
            congaRoutingHelper.GetCongaRouting(spine1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.3.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf1_spine1_2.Get(1)->GetIfIndex());
        }
        congaRoutingHelper.GetCongaRouting(spine1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine1_1.Get(1)->GetIfIndex());
        congaRoutingHelper.GetCongaRouting(spine1->GetObject<Ipv4>())->AddRoute(Ipv4Address("10.1.2.0"), Ipv4Mask("255.255.255.0"), netdevice_leaf0_spine1_2.Get(1)->GetIfIndex());
    }
    else
    {
