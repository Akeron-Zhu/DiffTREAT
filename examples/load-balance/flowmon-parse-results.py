...
class Flow(object):
    ...
    def __init__(self, flow_el):
        ...
        discLost = float(flow_el.get('queueDiscLostPacket'))
        self.queueDiscLostPacket = discLost
...
def main(argv):
    ...
    for sim in sim_list:
        for flow in sim.flows:
            ...
            disc_lost_packets += flow.queueDiscLostPacket
            ...
            print "FlowID: %i (%s %s/%s --> %s/%i)" % \
                (flow.flowId, proto, t.sourceAddress, t.sourcePort,
    ...
    print "Disc Lost Packets: %i" % disc_lost_packets
